...
VersionTriplet VersionTriplet::getCurrentVersion(){return VersionTriplet(ProjectInfo::versionNumber);}
const char* VersionTriplet::getProductName()    { return ProjectInfo::projectName; }
...
VersionTriplet VersionTriplet::getMasked(int level)const{
    return VersionTriplet(level>2?-1:major,level>1?-1:minor,level>0?-1:patch);
